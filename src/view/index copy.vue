                    ...
                    <div class="list" v-for="(item,index) in msgList" :key="index">
                        ...
                        <div class="select-box" >
                            ...
                            <div v-if="item.o3">
                                <span>C.{{item.o3}}</span>
                                <p>
                                    <img v-if="item.correctanswer  == 'C'" src="@/assets/img/index/Y.png" alt="" srcset="">
                                    <img v-if="item.correctanswer  != 'C'" src="@/assets/img/index/N.png" alt="" srcset="">
                                </p> 
                            </div>
                            <div v-if="item.o4">
                                <span>D.{{item.o4}}</span>
                                <p>
                                    <img v-if="item.correctanswer  == 'D'" src="@/assets/img/index/Y.png" alt="" srcset="">
                                    <img v-if="item.correctanswer  != 'D'" src="@/assets/img/index/N.png" alt="" srcset="">
                                </p> 
                            </div>
                        </div>
                    </div>
                ...
                <div class="list-box" v-if="!hasAnswered">
                    <div class="list" v-for="(item,index) in msgList" :key="index">
                        ...
                        <div class="select-box" >
                            ...
                            <div @click="selectChange(item,index,'C')" v-if="item.o3">
                                <span>C.{{item.o3}}</span>
                                <p v-if="questions1[index].seleced == 'C'" style="background:#1c4b5e"></p> 
                                <p v-else></p> 
                            </div>
                            <div @click="selectChange(item,index,'D')"  v-if="item.o4">
                                <span>D.{{item.o4}}</span>
                                <p v-if="questions1[index].seleced == 'D'" style="background:#1c4b5e"></p>
                                <p v-else></p>  
                            </div>
                        </div>
                    </div>
...
export default {
    data(){
        return{
            // openid:'NitISTV4M0I3WXBvenNxQUh6YkdqRVpRYzZXRGU2UXFSL21Bb3IrMUJ5QT0',
            openid:null,
    ...
    methods:{
        getQuestion(){
            ...
            that.axios.get('/api/Short/GetQuestionByDate',{
                ...
                //         ocount: "2",
                //         phone: null,
                //         showDate: "2022-05-14 00:00:00",
                //         title: "根除Hp可降低我国胃癌的发生风险，有效预防胃癌"
                //     },
                //     {
                //         answer: "引起慢性胃炎",
                //         correctanswer: "D",
        ...
        selectChange(item,index,type){
            ...
            if(type =='A'){
                ...
                this.questions1[index].answer = item.o3;
            }else if(type =='D'){
                this.questions1[index].answer = item.o4;
            }
